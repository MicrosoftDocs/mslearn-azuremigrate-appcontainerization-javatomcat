...
sed -i "s%-Djava.awt.headless=true -Djava.security.egd=file:/dev/./urandom -Dairsonic.home=/var/airsonic%-Djava.awt.headless=true -Djava.security.egd=file:/dev/./urandom -Dairsonic.home=/var/airsonic -DMYSQL_SERVER_FULL_NAME=$MYSQL_HOSTNAME -DMYSQL_DATABASE_NAME=$MYSQL_DBNAME -DMYSQL_SERVER_ADMIN_LOGIN_NAME=$MYSQL_ADMIN_USER -DMYSQL_SERVER_ADMIN_PASSWORD=$MYSQL_ADMIN_PASS%" /etc/systemd/system/tomcat9.service
